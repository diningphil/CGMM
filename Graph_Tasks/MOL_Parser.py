...
# ----------------------- PARSE TARGETS -------------------------- #
target = []
with open(task_name + '_data/' + task_name + "_labels.txt") as f:
...
with open(task_name + '_data/' + task_name + "_dataset.mol") as f:
    end = False
...
with open(task_name + '_data/' + task_name + '_dataset', 'wb') as f:
