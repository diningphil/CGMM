...
class PPILoss(nn.Module):
    ...
    def forward(self, targets, outputs):
        ...
        score = self._calculate_micro_f1_score(outputs.cpu().round().long().numpy(), targets.cpu().long().numpy())
        return loss, score

    def _get_correct(self, outputs):
        raise NotImplementedError()

    def _calculate_micro_f1_score(self, outputs, targets):
        """
        Computes the micro average F1 score
        :param outputs: 
        :param targets: 
        :return: 
        """
